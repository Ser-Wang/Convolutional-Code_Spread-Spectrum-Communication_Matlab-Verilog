...
%     [ber_num(i_ebno), ber(i_ebno,1)] = biterr(info_bits, x_esti_hard);
%     [ber_num(i_ebno), ber(i_ebno,2)] = biterr(info_bits, x_esti_unquant);
%     [ber_num(i_ebno), ber(i_ebno,3)] = biterr(info_bits, x_esti_3bit_T);
    [ber_num(i_ebno), ber(i_ebno,1)] = biterr(info_bits, x_esti_3bit_T);
end
